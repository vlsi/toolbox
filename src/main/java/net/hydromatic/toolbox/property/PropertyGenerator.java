 ...
 */
package net.hydromatic.toolbox.property;
...
public class PropertyGenerator {
  ...
  /** Creates a PropertyGenerator. */
  public PropertyGenerator(File xmlFile, File javaFile, File propertiesFile,
      File htmlFile) {
  ...
  public static void main(String[] args) {
    try {
      new PropertyGenerator(
          ...
          new File("target/generated-sources/prop/mondrian/olap",
              "MondrianProperties.java"),
          new File("mondrian.properties.template"),
          new File("doc", "properties.html")).generate();
    } catch (Throwable e) {
  ...
  /** Different kinds of files that can be generated. */
  enum Generator {
    JAVA {
      void generate(SortedMap<String, PropertyDef> propertyDefinitionMap,
        ...
        final String content = "Configuration properties that determine the\n"
    ...
    PROPERTIES {
      void generate(SortedMap<String, PropertyDef> propertyDefinitionMap,
          File file, PrintWriter out) {
        printComments(out, "", "#",
            wrapText("Generated by PropertyGenerator, "
                + "part of net.hydromatic:toolbox"));
        out.println();
